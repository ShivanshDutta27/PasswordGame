...
export default function Home() {
    ...
    function checkRules(txt) {
        ...
        // base case: unlock first rule if user has started typing
        ...
        for (let i = 0; i < rules.length; i++) {
            if (i === max_unlocked_rules.current) { // next rule is locked
                if (solved_count === max_unlocked_rules.current) { // if all previous rules are solved
        ...
        setRuleState(rules);
        setAllSolved(solved_count === rules.length);
    }
    ...
    return (
        <>
            ...
            <footer className={styles.footer}>
                <p>Made by Shivansh Dutta</p>
                Check out the <a href="https://github.com/ShivanshDutta27/PasswordGame" target="_blank">GitHub</a> for this project. <br />
